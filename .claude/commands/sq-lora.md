...
| the_real_mccoy | landscape | queued | `the_real_mccoy` | 8 | 1500 | — | World-divergent (1878 Pittsburgh); training candidates defined in world's `visual_style.yaml::lora_triggers.training_candidates` |
